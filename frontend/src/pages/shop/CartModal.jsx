   ...
   <div className='cart-items'>
{
    products.length === 0 ? (<div>Your Cart Is Empty </div>) : (
            ...
            products.map((item, index)=>(
                <div key={index} className='flex flex-col md:flex-row md:items-center md:justify-between shadow-md md:p-5p-2 mb-4'>
                    ...
                    <div className='flex flex-row md:justify-start *:justify-end items-center mt-2'>
                        ...
                        className='size-6 flex items-center px-1.5 rounded-full bg-gray-200
